...
# -*- encoding: utf-8 -*-
# stub: rspec-page-regression-html-formatter 0.3.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rspec-page-regression-html-formatter"
  s.version = "0.3.1"
  ...
  s.homepage = "https://github.com/abersager/rspec-page-regression-html-formatter"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.4.5"
  s.summary = "Custom HTML formatter for rspec-page-regression to allow visual comparison"
